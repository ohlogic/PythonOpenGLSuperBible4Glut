...
def InitGL(Width, Height):	
    ...
    img = Image.open("floor.jpg").convert("RGB")
    ...
    glTexImage2D(GL_TEXTURE_2D,0,GL_RGB,img.width, img.height, 0,
        GL_RGB, GL_UNSIGNED_BYTE, raw_image)

    img = Image.open("block4.jpg").convert("RGB")
    raw_image = img.tobytes()
    ...
    img = Image.open("block5.jpg").convert("RGB")
    raw_image = img.tobytes()
    ...
    img = Image.open("block6.jpg").convert("RGB")
    raw_image = img.tobytes()
